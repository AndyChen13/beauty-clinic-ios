# Beauty Clinic iOS - Xcode Project Files

## Project Information

- **App Name**: Beauty Clinic
- **Bundle ID**: com.beautyclinic.app (change as needed)
...
2. Check `PROJECT_README.md` for architecture overview